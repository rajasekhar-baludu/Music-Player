...
const songs = [
    ...
    {
        id:"8",
        songName: `Lost in Japan <br><div class="subtitle">Shawn Mendes</div>`,
        poster: "img/8.jpg",
    },
    {
        id:"9",
    ...
    {
        id:"12",
        songName: `Strip That Down <br><div class="subtitle">Liam Payne</div>`,
        poster: "img/12.jpg",
    },
    {
        id:"13",
        songName: `What Am I <br><div class="subtitle">Why Don't We</div>`,
        poster: "img/13.jpg",
    },
    {
        id:"14",
...
right_scrolls.addEventListener('click', ()=>{
  ...
  const songSide = document.getElementById('songSide');
  const toggleButton = document.getElementById('toggleMode');

  // Check if the user's preference is set to dark mode (optional)
  const userPrefersDark = window.matchMedia('(prefers-color-scheme: dark)').matches;
  if (userPrefersDark) {
    songSide.classList.add('dark-mode');
  }

  // Function to toggle between light and dark mode
  function toggleDarkMode() {
    songSide.classList.toggle('dark-mode');
  }
